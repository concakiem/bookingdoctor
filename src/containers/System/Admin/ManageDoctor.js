...
class ManageDoctor extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if(prevProps.allRequiredDoctorInfor !== this.props.allRequiredDoctorInfor) {
            //console.log('>>> chian95 get data from redux: ', this.props.allRequiredDoctorInfor)
            ...
            //console.log('chian95: data new: ', dataSelectPrice, dataSelectPayment, dataSelectProvince)
    ...
    render() {
        let { hasOldData } = this.state;
        //console.log('chian95 check state: ', this.state)
        return (
